...
export default function ChangePassword({ uid, user }: any) {

    const dispatch = useDispatch();
    const changePw = useSelector((state: any) => state.changePassword);

    const isShowPw = (id: string, e: any) => {
        const elementInput = document.getElementById(id) as HTMLInputElement;
        ...
        <div className="profile-box pw">
            ...
            <Formik 
                    ...
                    onSubmit={(values: any): void => {
                        ...
                        dispatch(userService.changePassword(uid, values));
                    }}>
