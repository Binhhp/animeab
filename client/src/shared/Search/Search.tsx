...
export const Search = React.memo(function Search() {
    const list = useSelector((state: any) => state.animes.data);
    ...
    const [requestTimer, setRequestTimer] = useState<any>(null);
    ...
    return (
      <form onSubmit={hanlderSubmit} className="search-content">
          ...
          <Autocomplete
            ...
            onSelect={(value: string, state: any) => setState({ ...state, value: value, animes: [state] }) }
            ...
            onChange={e => {
              ...
              const data = fakeRequest(e.target.value, list, (items: any) => {
